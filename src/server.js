// ⚠️ CRITICAL: Initialize  BEFORE all other imports to prevent circular dependency issues
import dotenv from "dotenv";
dotenv.config();

import { PrismaClient } from "@prisma/client";
import { setupPrismaGlobal } from "./setupPrismaGlobal.js";

// ✅ Create singleton and attach to globalThis FIRST
const prisma = new PrismaClient();
setupPrismaGlobal(prisma);
console.log("✅ Global PrismaClient singleton initialized in server.js");

// NOW we can import other modules that depend on the singleton
